...
public class MultiThread {
    ...
    public MultiThread(int[][] matrix1, int[][] matrix2, int threads) {
    ...
    public MultiThread(int[][] matrix1, int[][] matrix2, int[][] result, int threads, int matrixSize) {
        this.matrix1 = matrix1;
        this.matrix2 = matrix2;
        this.result = result;
        this.threads = threads;
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        MultiThread multiplier = new MultiThread(matrix1, matrix2, threads);
